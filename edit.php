...
if($_POST){
    ...
    $sql = "UPDATE todo SET title= '$title',description='$decs' WHERE id =  '$id' ";
    $pdostatement = $pdo->prepare($sql);
    $result = $pdostatement->execute();
    if($result){
        echo "<script>alert('New todo is updated'); 
        ...
        <div class="card-body">
            ...
            <form action="" method="post" class="form">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="" cols="30" rows="8" class="form-control" ><?= $result[0]['description']  ?></textarea>
                </div>
                <div class="form-group">
